...
namespace RPG.Database
{
    public class CraftSystem : MonoBehaviour
    {
        ...
        public void backToInventory()
        {
            ...
            {
                GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerInventoryManager>().GetInventoryPanel().GetComponent<Inventory>().addItemToInventory(itemInCraftSystem[i].itemID, itemInCraftSystem[i].itemValue);
