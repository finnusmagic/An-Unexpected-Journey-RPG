...
{
    public class Item_Manager : EditorWindow
    {
        [MenuItem("RPG/Item Manager")]
        static void Init()
        {
            EditorWindow.GetWindow(typeof(Item_Manager));
        ...
        void InputManager1()
        {
            ...
            inputManagerDatabase.SplitItemKeyCode = (KeyCode)EditorGUILayout.EnumPopup("Split", (KeyCode)inputManagerDatabase.SplitItemKeyCode);
