...
Shader "BOXOPHOBIC/LowPolyWater/LOW Cubemap"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float3 temp_output_343_0 = reflect( normalize( ( ase_worldPos - _WorldSpaceCameraPos ) ) , NORMAL );
			float3 reflectDir = ( ( ( min( min( max( ( ( (unity_SpecCube0_BoxMax.xyz) - ase_worldPos ) / temp_output_343_0 ) , ( ( (unity_SpecCube0_BoxMin.xyz) - ase_worldPos ) / temp_output_343_0 ) ).x , max( ( ( (unity_SpecCube0_BoxMax.xyz) - ase_worldPos ) / temp_output_343_0 ) , ( ( (unity_SpecCube0_BoxMin.xyz) - ase_worldPos ) / temp_output_343_0 ) ).y ) , max( ( ( (unity_SpecCube0_BoxMax.xyz) - ase_worldPos ) / temp_output_343_0 ) , ( ( (unity_SpecCube0_BoxMin.xyz) - ase_worldPos ) / temp_output_343_0 ) ).z ) * temp_output_343_0 ) + ase_worldPos ) - (unity_SpecCube0_ProbePosition.xyz) );
			...
			fixed4 ALBEDO = lerp( lerp( REFLECTION , WATERCOLOR , FRESNEL ) , EDGECOLOR , EDGE );
			o.Albedo = ALBEDO.rgb;
			float temp_output_378_0 = ( 1.0 - EDGE );
			...
			fixed OPACITY = saturate( ( EDGE + ( ( 1.0 - DEPTH ) * 2.0 ) ) );
			o.Alpha = OPACITY;
		}
...
/*ASEBEGIN
Version=7201
1927;29;1906;1014;2551.002;3867.404;1;True;False
...
Node;AmplifyShaderEditor.LerpOp;6;-1536,0;Float;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0.0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.CustomExpressionNode;341;-1280,-768;Float;False;unity_SpecCube0_BoxMax.xyz;3;0;0;1;FLOAT3
Node;AmplifyShaderEditor.WorldPosInputsNode;338;-1280,-352;Float;False;0;4;FLOAT3;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.CustomExpressionNode;337;-1280,-416;Float;False;unity_SpecCube0_BoxMin.xyz;3;0;0;1;FLOAT3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;352;64,-768;Float;False;2;0;FLOAT;0.0;False;1;FLOAT3;0.0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.SimpleAddOpNode;355;224,-768;Float;False;2;0;FLOAT3;0.0;False;1;FLOAT3;0.0,0,0;False;1;FLOAT3
Node;AmplifyShaderEditor.CustomExpressionNode;354;208,-560;Float;False;unity_SpecCube0_ProbePosition.xyz;3;0;0;1;FLOAT3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;261;-448,-1280;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.OneMinusNode;367;-752,-1408;Float;False;1;0;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.SimpleAddOpNode;368;-1104,-1536;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.CustomExpressionNode;359;640,-672;Float;False;UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, reflectDir,0);4;1;True;reflectDir;FLOAT3;0,0,0;1;0;FLOAT3;0,0,0;False;1;FLOAT4
...
Node;AmplifyShaderEditor.CustomExpressionNode;361;848,-672;Float;False;DecodeHDR(reflectionHDR, unity_SpecCube0_HDR);3;1;True;reflectionHDR;FLOAT4;0,0,0,0;1;0;FLOAT4;0,0,0,0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;82;-1664,880;Float;False;2;0;FLOAT;0,0,0,0;False;1;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.AbsOpNode;222;-1264,-2064;Float;False;1;0;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;383;1120,-672;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0.0,0,0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.AppendNode;159;-1440,992;Float;False;FLOAT3;0;0;0;0;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;375;192,-1280;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.SimpleAddOpNode;92;-1472,816;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.OneMinusNode;313;-1120,-2064;Float;False;1;0;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.LerpOp;363;1408,-768;Float;False;3;0;COLOR;0.0;False;1;FLOAT3;0.0,0,0,0;False;2;FLOAT;0.0,0,0;False;1;COLOR
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;384;-1536,-2432;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;2.0;False;1;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;84;-1152,640;Float;False;2;0;FLOAT;0.0;False;1;FLOAT3;0.0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;220;-976,880;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.1;False;1;FLOAT
Node;AmplifyShaderEditor.SimpleAddOpNode;316;-1280,-2560;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;57;-768,640;Float;False;2;0;FLOAT3;0.0;False;1;FLOAT;0.0,0,0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;329;-1536,-4400;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;330;-1536,-4496;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-1152,-4608;Float;False;True;2;Float;ASEMaterialInspector;0;BlinnPhong;BOXOPHOBIC/LowPolyWater/LOW Cubemap;False;False;False;False;False;False;False;False;False;False;False;False;Off;0;0;False;0;0;Transparent;0.5;True;False;0;False;Transparent;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;False;0.5;True;0;SrcAlpha;OneMinusSrcAlpha;0;SrcAlpha;OneMinusSrcAlpha;OFF;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;Relative;0;BOXOPHOBIC/LowPolyWater/MOBILE Cubemap;-1;-1;-1;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;13;OBJECT;0.0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.CommentaryNode;273;-2176,-3712;Float;False;100;100;;0;// WATER / EGDE COLORS;0;0
Node;AmplifyShaderEditor.CommentaryNode;279;-2176,640;Float;False;100;100;;0;// WAVE ANIMATION;0;0
Node;AmplifyShaderEditor.CommentaryNode;303;-2176,-2064;Float;False;100;100;;0;// FRESNEL CONTROL;0;0
Node;AmplifyShaderEditor.CommentaryNode;278;-2176,0;Float;False;100;100;;0;// NORMALS;0;0
...
ASEEND*/
//CHKSM=CFCC7E5A396A64A424122C6999B4C1447A3315A9