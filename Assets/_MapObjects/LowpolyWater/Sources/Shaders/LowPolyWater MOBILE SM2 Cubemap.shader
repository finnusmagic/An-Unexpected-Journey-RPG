...
Shader "BOXOPHOBIC/LowPolyWater/MOBILE SM2 Cubemap"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float3 temp_output_357_0 = reflect( normalize( ( ase_worldPos - _WorldSpaceCameraPos ) ) , NORMAL );
			float3 reflectDir = ( ( ( min( min( max( ( ( (unity_SpecCube0_BoxMax.xyz) - ase_worldPos ) / temp_output_357_0 ) , ( ( (unity_SpecCube0_BoxMin.xyz) - ase_worldPos ) / temp_output_357_0 ) ).x , max( ( ( (unity_SpecCube0_BoxMax.xyz) - ase_worldPos ) / temp_output_357_0 ) , ( ( (unity_SpecCube0_BoxMin.xyz) - ase_worldPos ) / temp_output_357_0 ) ).y ) , max( ( ( (unity_SpecCube0_BoxMax.xyz) - ase_worldPos ) / temp_output_357_0 ) , ( ( (unity_SpecCube0_BoxMin.xyz) - ase_worldPos ) / temp_output_357_0 ) ).z ) * temp_output_357_0 ) + ase_worldPos ) - (unity_SpecCube0_ProbePosition.xyz) );
			float4 reflectionHDR = (UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, reflectDir,0));
			fixed3 REFLECTION = (DecodeHDR(reflectionHDR, unity_SpecCube0_HDR));
			fixed4 ALBEDO = lerp( _WaterColor , float4( REFLECTION , 0.0 ) , _ReflectionIntensity );
			...
			fixed DEPTH = saturate( pow( ( _DepthOffset + abs( ( eyeDepth334 - ase_screenPos333.w ) ) ) , ( 1.0 - max( _DepthFalloff , 1.0 ) ) ) );
			fixed OPACITY = saturate( ( ( 1.0 - DEPTH ) * 2.0 ) );
			o.Alpha = OPACITY;
		}
...
/*ASEBEGIN
Version=7201
1927;29;1906;1014;2590.589;2992.467;1;True;False
...
Node;AmplifyShaderEditor.LerpOp;6;-1536,-512;Float;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0.0;False;1;FLOAT3
Node;AmplifyShaderEditor.WorldPosInputsNode;349;-1280,-736;Float;False;0;4;FLOAT3;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.CustomExpressionNode;352;-1280,-800;Float;False;unity_SpecCube0_BoxMin.xyz;3;0;0;1;FLOAT3
...
Node;AmplifyShaderEditor.CustomExpressionNode;350;-1280,-1152;Float;False;unity_SpecCube0_BoxMax.xyz;3;0;0;1;FLOAT3
...
Node;AmplifyShaderEditor.SimpleAddOpNode;383;-1136,-1664;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.OneMinusNode;382;-784,-1536;Float;False;1;0;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;365;64,-1152;Float;False;2;0;FLOAT;0.0;False;1;FLOAT3;0.0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.SimpleAddOpNode;368;224,-1152;Float;False;2;0;FLOAT3;0.0;False;1;FLOAT3;0.0,0,0;False;1;FLOAT3
Node;AmplifyShaderEditor.CustomExpressionNode;367;208,-944;Float;False;unity_SpecCube0_ProbePosition.xyz;3;0;0;1;FLOAT3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;82;-1664,368;Float;False;2;0;FLOAT;0,0,0,0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.AppendNode;159;-1440,480;Float;False;FLOAT3;0;0;0;0;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT3
Node;AmplifyShaderEditor.RegisterLocalVarNode;386;-256,-1664;Fixed;False;DEPTH;-1;True;1;0;FLOAT;0,0,0,0;False;1;FLOAT
Node;AmplifyShaderEditor.SimpleAddOpNode;92;-1472,304;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.CustomExpressionNode;372;576,-1152;Float;False;UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, reflectDir,0);4;1;True;reflectDir;FLOAT3;0,0,0;1;0;FLOAT3;0,0,0;False;1;FLOAT4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;84;-1280,304;Float;False;2;0;FLOAT;0.0;False;1;FLOAT3;0.0;False;1;FLOAT3
Node;AmplifyShaderEditor.CustomExpressionNode;374;832,-1152;Float;False;DecodeHDR(reflectionHDR, unity_SpecCube0_HDR);3;1;True;reflectionHDR;FLOAT4;0,0,0,0;1;0;FLOAT4;0,0,0,0;False;1;FLOAT3
Node;AmplifyShaderEditor.OneMinusNode;388;-1728,-2048;Float;False;1;0;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;393;-1536,-2048;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;2.0;False;1;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;220;-1104,544;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.1;False;1;FLOAT
...
Node;AmplifyShaderEditor.LerpOp;396;-1536,-2688;Float;False;3;0;COLOR;0.0;False;1;FLOAT3;0.0,0,0,0;False;2;FLOAT;0.0;False;1;COLOR
Node;AmplifyShaderEditor.SaturateNode;317;-1280,-2048;Float;False;1;0;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;57;-896,304;Float;False;2;0;FLOAT3;0.0;False;1;FLOAT;0.0,0,0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-1536,-3456;Float;False;True;0;Float;ASEMaterialInspector;0;Unlit;BOXOPHOBIC/LowPolyWater/MOBILE SM2 Cubemap;False;False;False;False;True;True;True;True;True;False;True;True;Off;0;0;False;0;0;Transparent;0.5;True;False;0;False;Transparent;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;False;0.5;False;0;SrcAlpha;OneMinusSrcAlpha;0;SrcAlpha;OneMinusSrcAlpha;OFF;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;Relative;0;Standard;-1;-1;-1;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;13;OBJECT;0.0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.CommentaryNode;306;-2176,-2048;Float;False;100;100;;0;// OPACITY;0;0
Node;AmplifyShaderEditor.CommentaryNode;378;-2176,-1152;Float;False;100;100;;0;// REFLECTION;0;0
Node;AmplifyShaderEditor.CommentaryNode;272;-2176,-2688;Float;False;100;100;;0;// ALBEDO;0;0
Node;AmplifyShaderEditor.CommentaryNode;278;-2176,-512;Float;False;100;100;;0;// NORMALS;0;0
Node;AmplifyShaderEditor.CommentaryNode;274;-2176,-1664;Float;False;100;100;;0;// DEPTH AND EDGE CONTROL;0;0
Node;AmplifyShaderEditor.CommentaryNode;280;-2176,-3456;Float;False;100;100;;0;// FINAL;0;0
Node;AmplifyShaderEditor.CommentaryNode;279;-2176,128;Float;False;100;100;;0;// WAVE ANIMATION;0;0
...
ASEEND*/
//CHKSM=E826655A464C70035A3EC2B9E8C6BDBC8678517C